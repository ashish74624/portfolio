...
export default function Project() {
    ...
    const projects = [
        ...
        { id: 3, title: "Pixel Pry", desc: "An Image drop and retrieve website", stack: "React | Tailwind Css |  Express js | Mongo Db", image: "/img.png", img1: "/img.png", img2: "/i2.png", img3: "/i3.png", img4: "/i4.png", img5: "/i5.png", github: "https://github.com/ashish74624/Pixel-Pry-TechNexus", link: "https://tech-nexus.vercel.app/" },
        { id: 4, title: "ShelfWise", desc: "Library Management System", stack: "React Js | Tailwind Css |Express | Mongo Db", image: "/lib.png", img1: "/lib.png", img2: "/l2.png", img3: "/l3.png", img4: undefined, img5: undefined, github: "https://github.com/ashish74624/ShelfWise", link: "https://shelfwise.vercel.app/" },
        { id: 5, title: "UpFront", desc: "A News website", stack: "Next js | Tailwind Css", image: "/upfront.png", img1: "/upfront.png", img2: "/u2.png", img3: "/u3.png", img4: "/u4.png", img5: "/u5.png", github: "https://github.com/ashish74624/UpFront", link: "https://upfront-fawn.vercel.app/" },
    ]
