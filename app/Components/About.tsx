  ...
  return (
    <section id='me' className='w-screen h-max bg-white overflow-hidden flex flex-col items-center mb-10'>
      ...
      <div className=' flex md:flex-row flex-col mx-0 md:mx-auto md:w-max'>
        ...
        <p className='text-xl w-[95vw] md:w-[80vw] lg:w-[600px] md:text-2xl my-6 lg:m-6'>
        I&#39;m Ashish Kumar. <br /> I&#39;m a full-stack developer from Delhi, Currently pursuing my B.E in Bangalore, <br />Well-versed in developing efficient API&apos;s with Express Js and Mongo Db. Excels in HTML, CSS, JavaScript and React development
